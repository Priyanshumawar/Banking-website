...
<head>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><h3>Goldman Bank</h3></a>
    ...
    <body style="background-color: #80b896";>
    <?php
    ...
    //   change
              ...
              $sql= "UPDATE `bank details` SET `account balance` = `account balance`+'$amount' WHERE `bank details`.`Name` = '$receiver'";
              $result = mysqli_query($conn, $sql);
              $sql= "UPDATE `bank details` SET `account balance` = `account balance`-'$amount' WHERE `bank details`.`Name` = '$sender'";
              $result = mysqli_query($conn, $sql);
               if($result)
               {
 ...
 <footer class="text-center mt-2 py-3">
        <p>&copy 2021 <b>Priyanshu Mawar</b></p>
        <p>This is an project.</p>
    </footer>
